...
AppDataHandler.prototype.handle = function (rxInfoArr, appObj) {
  ...
  return BluebirdPromise
    ...
    _this.deviceInfo.update(uploadDataDevAddr, { FCntUp: newFCnt }),
...
AppDataHandler.prototype.updateDeviceRouting = function (deviceStatus) {
  ...
  return _this.deviceInfo.read(deviceStatus.DevAddr).then(function (res) {
    if (res) {
      ...
      return _this.deviceInfo.update(DevAddr, updateOpts);
