...
const pubNCTopic = config.msgQueue.topics.pubToConnector;
  ...
  let generateDownlink = function (txJson, downlinkJson) {
    ...
    return convertFn(txJson, downlinkJson, uplinkInfo)
      .then(function (dlkObj) {
        ...
        return _this.mqClient.publish(pubNCTopic, dlkObj).then(function (res) {
